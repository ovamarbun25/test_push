...
$ret2=mysqli_query($con,"SELECT * FROM templatesertifikatpenyelenggara WHERE IdPenyelenggara= $_SESSION[id]");
$nomor = 1;
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 style="2222222222">
                                Template Sertifikat Penyelenggara
                            </h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                <?php $modal2 = 0; ?>
                                <?php foreach (mysqli_fetch_all($ret2) as $x) {?>
                                    <div class="col-md-55">
                                        <div class="thumbnail">
                                            <div class="image view view-first">
                                                <img style="width: 100%; display: block;" src="../admin/images/<?php echo $x[3]?>" alt="image" />
                                                <div class="mask">
                                                    <p><?php echo $x[2]?></p>
                                                    <div class="tools tools-bottom">
                                                        <a href="ubahTemplate.php?idTemplate=<?php echo $x[0]?>" title="Edit"><i class="fa fa-pencil"></i></a>
                                                        <a type="button" data-id="<?php echo $x[0]?>" id="temp" data-toggle="modal" data-target="#myModal<?php echo $modal2; ?>" title="Delete"><i class="fa fa-times"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="caption">
                                            ...
                                            <div class="modal" id="myModal<?php echo $modal2; ?>" tabindex="-1" role="dialog">
                ...
                <div class="col-md-12">
                      <div class="x_panel">
                        <div class="x_title">
                          ...
                          <ul class="nav navbar-right panel_toolbox" style="right: 0;">
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-md-55">
                                    ...
                                    <div class="caption">
                                        <p style="hight:100%"><?php echo $x[2]?></p>
                                    </div>
                                    </div>
                                </div>
                                <?php $modal++;
