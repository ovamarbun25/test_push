        ...
        <div class="right_col" role="main">
            <div class="">
                ...
                <div class="signup-form">
                    <form method="post" enctype="multipart/form-data" action="upload_aksi.php?idAcara=<?php echo $data[0]?>">
                        <h1 class="text-center" style="color:#000000 ">Form Import</h1>
                        <hr>
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <input name="filepeserta" type="file" required="required" accept=".xls,.xlsx">
