                    ...
                    <form action="ubahAcaraAksi.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="ubahnamaAcara" class="form-control" placeholder="Nama Acara" value="<?php echo $data[2]?>" type="text" style="background-color: white" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <?php
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" name="ubahtanggalAcara" type="datetime-local" value="<?php echo $newDate?>" style="background-color: white" readonly>
                            </div>
                        </div>
                        <!--                                        LOGO-->
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" name="ubahlogoAcara" type="text" value="<?php echo $data[5]?>" style="background-color: white" readonly>
                            </div>
                        </div>
                        <!--                                        PENANDATANGAN 1-->
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="ubahnamaPenandatangan1" class="form-control" placeholder="Nama Penandatangan 1" value="<?php echo $data[8] ?>" type="text" style="background-color: white" readonly>
                            </div>
                        </div>
                        <!--                                        PENANDATANGAN 2-->
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input name="ubahnamaPenandatangan2" class="form-control" placeholder="Nama Penandatangan 1" value="<?php echo $data[9] ?>" type="text" style="background-color: white" readonly>
                            </div>
                        </div>
                        <!--                                        //TTD1-->
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" name="ubahparaf1" type="text" value="<?php echo $data[6]?>" style="background-color: white" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input class="form-control" name="ubahparaf2" type="text" value="<?php echo $data[7]?>" style="background-color: white" readonly>
                            </div>
                        </div>

                        <div class="form-group">
                            <button type="submit" name="back" class="btn btn-secondary btn-block"> Kembali  </button>
                        </div>
                    </form>
                </div>
            </div>
