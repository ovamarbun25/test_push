            ...
            <div class="">
                ...
                <div class="signup-form">
                    <form action="prosesSimpan.php" method="post" enctype="multipart/form-data">
                        <h1 class="text-center" style="color:#000000 ">Upload Template</h1>
                        <hr>
                        <input name="idAdmin" class="form-control" value="<?php echo $_SESSION['id']?>" type="hidden">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fas fa-file-signature"></i> </span>
                                </div>
                                <input name="namaTemplate" class="form-control" placeholder="Nama Template" value="" type="text" required>
                            </div>
                        </div>
                        <!--                                        <div class="form-group">-->
                        <!--                                            <div class="input-group">-->
                        ...
                        <!--                                                    <span class="input-group-text"> <i class="fas fa-file-signature"></i> </span>-->
                        <!--                                                </div>-->
                        <!--                                                <select name="layout" class="form-control" id="exampleFormControlSelect1" required>-->
                        <!--                                                    <option value="" disabled selected hidden>Pilih Layout</option>-->
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <label class="file">
                                        <input name="gambarTemplate" type="file" id="file" required>
                        ...
                        <div class="form-group">
                            <button name="uploadGambar" class="btn1 btn-primary btn-lg btn-block"> UPLOAD  </button>
                            <a href="caraUploadTemplate.php"><button type="button" class="btn3 btn-primary btn-lg btn-block">Cara/Langkah-Langkah dalam membuat Template Sertifikat</button></a>
                        </div>
                    </form>
                </div>
            </div>
