...
if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
    ...
    if(move_uploaded_file($tmp, $path)){ // Cek apakah gambar berhasil diupload atau tidak
        ...
        $query = "UPDATE templatesertifikat SET NamaTemplate='".$namaTemplate."', Template='".$foto."' WHERE IdTemplate='".$idTemplate."'";
        $sql = mysqli_query($con, $query); // Eksekusi/ Jalankan query dari variabel $query
    ...
    // Proses ubah data ke Database
    $query = "UPDATE templatesertifikat SET NamaTemplate='".$namaTemplate."' WHERE IdTemplate='".$idTemplate."'";
    $sql = mysqli_query($con, $query); // Eksekusi/ Jalankan query dari variabel $query
